                    ...
                    <li class="item">
                        ...
                        <div class="info">
                            <ul id="Huifold1" class="Huifold">
                                ...
                                <li class="item">
                                   <a data-href="/admintwo/table/index?contentUrl={{$vieVule->contentUrl}}&filter={{$vieVule->filter}}" data-title="{{$vieVule->name}}" href="javascript:;" style="text-overflow:ellipsis;display:inline-block;white-space: nowrap;width: 100%;overflow:hidden;font-size:10px">{{$vieVule->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
