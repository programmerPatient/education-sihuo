        ...
        <div id="tab-system" class="HuiTab">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9" id="model">
                    ...
                    模式三&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" id="website-title" value="4" class="input-checkbox" name="model">
                    模式四
                </div>
            </div>
            <div class="row cl">
