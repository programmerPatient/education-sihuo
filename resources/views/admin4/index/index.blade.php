...
<aside class="Hui-aside" style="top:0;background-color: #23262e">
    <div class="menu_dropdown bk_2" >
        ...
        @foreach($p as $val)
        <dl id="menu-article">
            <dt style="text-overflow:ellipsis;border-bottom: 0px;color:#3a3c43" class="tableau-project"><i class="Hui-iconfont">&#xe616;</i>{{$val['name']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
